  ...
  return (
    <KeyboardAvoidingView
      ...
      <View className="flex-1 items-center justify-center  bg-blue-50">
        <Text className="text-4xl font-bold text-center text-blue-400">
          Travelolo
        </Text>
        ...
        <TextInput
          ...
          className="text-base border-2 border-gray-300 rounded-md p-2 mt-16 w-5/6"
          value={userName}
          onChangeText={text => {
            setUserName(text);
          }}
        ...
        <TouchableOpacity
          className="bg-white px-4 py-2 rounded-3xl w-5/6 border-2 border-blue-400"
